        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Narayana Institute</h3>
                <p className="text-gray-300 text-sm">Primary & Higher Secondary School</p>
              </div>
            </div>
            
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering students with quality education, innovative learning methodologies, and holistic development for over 25 years. We are committed to nurturing future leaders with academic excellence and character building.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-300">
                ...
                <span>123 Education Street, Hyderabad, Telangana</span>
              </div>
              <div className="flex items-center text-gray-300">
                <svg className="w-5 h-5 mr-3 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span>info@narayanainstitute.edu.in</span>
              </div>
            </div>
          </div>
