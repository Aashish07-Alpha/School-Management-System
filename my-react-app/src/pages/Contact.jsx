              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mb-1">Main Office: +91 98765 43210</p>
                    <p className="text-slate-600 mb-1">Admissions: +91 98765 43211</p>
                    <p className="text-slate-600">Emergency: +91 98765 43212</p>
                  </div>
                </div>
                ...
                */}
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 mb-1">Narayana Institute</p>
                    <p className="text-slate-600 mb-1">123 Education Street, Knowledge City</p>
                    <p className="text-slate-600 mb-1">Near Metro Station, KC 12345</p>
                    <p className="text-slate-600 mb-3">Bangalore, Karnataka, India</p>
                    <a 
                      href="https://maps.google.com/?q=Narayana+Institute+Knowledge+City+Bangalore"
                      target="_blank"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.1234567890123!2d77.5945663!3d12.9715987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sNarayana%20Institute!5e0!3m2!1sen!2sin!4v1703123456789"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-slate-700 font-medium">By Metro</p>
                    <p className="text-slate-600 text-sm">Nearest Metro Station: Knowledge City Metro (500m walk)</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Bus Routes: 123, 456, 789 (Stop: Education Street)</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
